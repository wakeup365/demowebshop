...
test("User add to wichlist", async (t) => {
  await login();
  ...
  await t
    ...
    .click(
      Selector("h2")
        .withText("Camera, photo")
        .find('[title="Show products in category Camera, photo"]')
    )
    .click(Selector("a").withText("Digital SLR Camera 12.2 Mpixel"))
    .click(Selector("#add-to-wishlist-button-18"))
    .click(Selector('[alt="Tricentis Demo Web Shop"]'))
